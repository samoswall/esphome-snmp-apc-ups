...
// firmware_revision
  snmp_agent_.addDynamicReadOnlyStringHandler(CUSTOM_OID "2.6.0", []() -> std::string { return App.get_text_sensors (firmware_revision->get_raw_state()); });
// last_battery_change_date
  snmp_agent_.addDynamicReadOnlyStringHandler(CUSTOM_OID "2.7.0", []() -> std::string { return App.get_text_sensors (last_battery_change_date->get_raw_state()); });
}
